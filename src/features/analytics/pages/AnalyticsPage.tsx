...
export default function AnalyticsPage() {
  ...
  return (
    <>
      {/* Main content — the global AppHeader supplies the page chrome/title bar. */}
      <main className="px-gutter pb-12 pt-6 min-h-screen max-w-container-max mx-auto w-full">
        {/* Page title + actions for mobile */}
        <div className="mb-xl md:hidden">
          ...
          <p className="text-on-surface-variant font-body-lg mb-md">
            {t('analytics:valueMetrics.subtitle')}
          </p>
          {headerActions}
        </div>
        {/* Page title + actions for desktop */}
